...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/encoders.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function concat() {
    for(var _len = arguments.length, bufs = new Array(_len), _key = 0; _key < _len; _key++){
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/nuid.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const nuid_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/nuid.js [app-client] (ecmascript)");
/**
...
function createInbox() {
    ...
    prefix.split(".").forEach((v)=>{
        if (v === "*" || v === ">") {
            throw new Error("inbox prefixes cannot have wildcards '".concat(prefix, "'"));
        }
    });
    return "".concat(prefix, ".").concat(nuid_1.nuid.next());
}
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/util.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const encoders_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/encoders.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
function extend(a) {
...
function timeout(ms) {
    let asyncTraces = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
...
function deadline(p) {
    let millis = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1000;
...
class Perf {
    ...
    measure(key, startKey, endKey) {
        ...
        if (s === undefined) {
            throw new Error("".concat(startKey, " is not defined"));
        }
        const e = this.timers.get(endKey);
        if (e === undefined) {
            throw new Error("".concat(endKey, " is not defined"));
        }
...
function backoffWithMax() {
    let max = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 30000;
    const a = [
        max
    ];
    while(true){
 ...
 * @param policy
 */ function backoff() {
    let policy = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [
        0,
        250,
        250,
        500,
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/databuffer.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class DataBuffer {
    ...
    fill(a) {
        for(var _len = arguments.length, bufs = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++){
            bufs[_key - 1] = arguments[_key];
        }
        if (a) {
            this.buffers.push(a);
            this.byteLength += a.length;
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/transport.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ const encoders_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/encoders.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
const databuffer_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/databuffer.js [app-client] (ecmascript)");
let transportConfig;
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/ipparser.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/servers.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const transport_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/transport.js [app-client] (ecmascript)");
const util_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/util.js [app-client] (ecmascript)");
const ipparser_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/ipparser.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
...
function hostPort(u) {
    ...
    const url = new URL("".concat(protocol, "://").concat(u));
    url.port = "".concat(port);
    ...
    resolve(opts) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            if ((0, ipparser_1.isIP)(this.hostname)) {
                ...
                if (opts.debug) {
                    console.log("resolve ".concat(this.hostname, " = ").concat(ips.join(",")));
                }
                for (const ip of ips){
                    ...
                    const url = new URL("".concat(proto, "://").concat(isIPV6(ip) ? "[" + ip + "]" : ip));
                    url.port = "".concat(this.port);
 ...
 */ class Servers {
    ...
    addServer(u) {
        let implicit = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
    ...
    constructor(listens = [], opts = {}){
        ...
        if (this.servers.length === 0) {
            this.addServer("".concat(core_1.DEFAULT_HOST, ":").concat((0, transport_1.defaultPort)()), false);
        }
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/queued_iterator.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/headers.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function canonicalMIMEHeaderKey(k) {
    ...
    for(let i = 0; i < k.length; i++){
        ...
        if (c === colon || c < start || c > end) {
            throw new core_1.NatsError("'".concat(k[i], "' is not a valid character for a header key"), core_1.ErrorCode.BadHeader);
        }
        if (upper && a <= c && c <= z) {
            c -= toLower;
...
function headers() {
    let code = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, description = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
...
class MsgHdrsImpl {
    ...
    toString() {
        ...
        if (this._code > 0 && this._description !== "") {
            s += " ".concat(this._code, " ").concat(this._description);
        }
        for (const [k, v] of this.headers){
    ...
    findKeys(k) {
        let match = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : core_1.Match.Exact;
    ...
    set(k, v) {
        let match = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : core_1.Match.Exact;
        this.delete(k, match);
    ...
    get status() {
        return "".concat(this._code, " ").concat(this._description).trim();
    }
    toRecord() {
        const data = {};
        this.keys().forEach((v)=>{
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/codec.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/msg.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const headers_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/headers.js [app-client] (ecmascript)");
const encoders_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/encoders.js [app-client] (ecmascript)");
const codec_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/codec.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
...
class MsgImpl {
    ...
    respond() {
        let data = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : encoders_1.Empty, opts = arguments.length > 1 ? arguments[1] : void 0;
        if (this.reply) {
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/muxsubscription.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const msg_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/msg.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
class MuxSubscription {
    ...
    init(prefix) {
        this.baseInbox = "".concat((0, core_1.createInbox)(prefix), ".");
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/heartbeats.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
    ...
    _schedule() {
        ...
        this.timer = setTimeout(()=>{
            this.ph.dispatchStatus({
                ...
                data: "".concat(this.pendings.length + 1)
            });
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/denobuffer.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function copy(src, dst) {
    let off = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/parser.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const denobuffer_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/denobuffer.js [app-client] (ecmascript)");
const encoders_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/encoders.js [app-client] (ecmascript)");
var Kind;
(function(Kind) {
    Kind[Kind["OK"] = 0] = "OK";
...
class Parser {
    ...
    fail(data) {
        let label = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
        if (!label) {
            label = "parse error [".concat(this.state, "]");
        } else {
            label = "".concat(label, " [").concat(this.state, "]");
        }
        return new Error("".concat(label, ": ").concat(encoders_1.TD.decode(data)));
    }
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/semver.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function parseSemVer() {
    ...
    throw new Error("'".concat(s, "' is not a semver value"));
}
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/nkeys.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
exports.nkeys = __turbopack_context__.r("[project]/dawg-ai/node_modules/nkeys.js/lib/index.js [app-client] (ecmascript)"); //# sourceMappingURL=nkeys.js.map
}),
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/authenticator.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const nkeys_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/nkeys.js [app-client] (ecmascript)");
const encoders_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/encoders.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/options.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const transport_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/transport.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
const authenticator_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/authenticator.js [app-client] (ecmascript)");
const core_2 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
...
function parseOptions(opts) {
    const dhp = "".concat(core_2.DEFAULT_HOST, ":").concat((0, transport_1.defaultPort)());
    opts = opts || {
        servers: [
            dhp
        ]
    ...
    if (opts.servers.length === 0 && opts.port) {
        opts.servers = [
            "".concat(core_2.DEFAULT_HOST, ":").concat(opts.port)
        ];
    }
    ...
    [
        ...
        if (options[n] && typeof options[n] !== "function") {
            throw new core_2.NatsError("".concat(n, " option should be a function"), core_2.ErrorCode.NotFunction);
        }
    });
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/protocol.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const util_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/util.js [app-client] (ecmascript)");
const databuffer_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/databuffer.js [app-client] (ecmascript)");
const servers_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/servers.js [app-client] (ecmascript)");
const queued_iterator_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/queued_iterator.js [app-client] (ecmascript)");
const muxsubscription_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/muxsubscription.js [app-client] (ecmascript)");
const heartbeats_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/heartbeats.js [app-client] (ecmascript)");
const parser_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/parser.js [app-client] (ecmascript)");
const msg_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/msg.js [app-client] (ecmascript)");
const semver_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/semver.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
const options_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/options.js [app-client] (ecmascript)");
...
class ProtocolHandler {
    ...
    processInfo(m) {
        ...
        if (!this.infoReceived) {
            ...
            try {
                ...
                this.transport.send((0, encoders_1.encode)("CONNECT ".concat(cs).concat(transport_1.CR_LF)));
    ...
    publish(subject) {
        let payload = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : encoders_1.Empty, options = arguments.length > 2 ? arguments[2] : void 0;
        let data;
        ...
        if (options.headers) {
            if (options.reply) {
                proto = "HPUB ".concat(subject, " ").concat(options.reply, " ").concat(hlen, " ").concat(len, "\r\n");
            } else {
                proto = "HPUB ".concat(subject, " ").concat(hlen, " ").concat(len, "\r\n");
            }
            this.sendCommand(proto, headers, data, transport_1.CRLF);
        } else {
            if (options.reply) {
                proto = "PUB ".concat(subject, " ").concat(options.reply, " ").concat(len, "\r\n");
            } else {
                proto = "PUB ".concat(subject, " ").concat(len, "\r\n");
            }
    ...
    _sub(s) {
        if (s.queue) {
            this.sendCommand("SUB ".concat(s.subject, " ").concat(s.queue, " ").concat(s.sid, "\r\n"));
        } else {
            this.sendCommand("SUB ".concat(s.subject, " ").concat(s.sid, "\r\n"));
        }
    }
    _subunsub(s) {
        this._sub(s);
    ...
    unsub(s, max) {
        ...
        if (max) {
            this.sendCommand("UNSUB ".concat(s.sid, " ").concat(max, "\r\n"));
        } else {
            this.sendCommand("UNSUB ".concat(s.sid, "\r\n"));
        }
        s.max = max;
    }
    resub(s, subject) {
    ...
    sendSubscriptions() {
        ...
        this.subscriptions.all().forEach((s)=>{
            const sub = s;
            if (sub.queue) {
                cmds.push("SUB ".concat(sub.subject, " ").concat(sub.queue, " ").concat(sub.sid).concat(transport_1.CR_LF));
            } else {
                cmds.push("SUB ".concat(sub.subject, " ").concat(sub.sid).concat(transport_1.CR_LF));
            }
        });
        if (cmds.length) {
    ...
    initMux() {
        ...
        if (!mux) {
            ...
            const sub = new SubscriptionImpl(this, "".concat(inbox, "*"));
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/types.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
...
var encoders_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/encoders.js [app-client] (ecmascript)");
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/request.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/jsutil.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function minValidation(context) {
    ...
    bad.forEach((v)=>{
        if (name.indexOf(v) !== -1) {
            ...
            throw Error("invalid ".concat(context, " name - ").concat(context, " name cannot contain '").concat(v, "'"));
        }
    });
    return "";
}
function validateName(context) {
    ...
    if (m.length) {
        throw new Error("invalid ".concat(context, " name - ").concat(context, " name ").concat(m));
    }
}
function validName() {
    ...
    if (m === null) {
        for (const c of name.split("")){
            const mm = c.match(RE);
            if (mm === null) {
                return "cannot contain '".concat(c, "'");
            }
        }
    }
    return "";
...
function checkJsErrorCode(code) {
    ...
    switch(code){
        ...
        default:
            ...
            return new core_1.NatsError(description, "".concat(code));
    }
} //# sourceMappingURL=jsutil.js.map
}),
"[project]/dawg-ai/node_modules/nats/lib/jetstream/jsbaseclient_api.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const codec_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/codec.js [app-client] (ecmascript)");
const util_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/util.js [app-client] (ecmascript)");
const jsutil_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsutil.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
...
function defaultJsOptions(opts) {
    opts = opts || {};
    if (opts.domain) {
        opts.apiPrefix = "$JS.".concat(opts.domain, ".API");
        delete opts.domain;
    }
...
class BaseApiClient {
    ...
    _request(subj_1) {
        return __awaiter(this, arguments, void 0, function*(subj) {
            let data = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, opts = arguments.length > 2 ? arguments[2] : void 0;
            opts = opts || {};
    ...
    findStream(subject) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            const r = yield this._request("".concat(this.prefix, ".STREAM.NAMES"), q);
            const names = r;
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/jslister.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class ListerImpl {
    ...
    countResponse(r) {
        ...
        switch(r === null || r === void 0 ? void 0 : r.type){
            ...
            default:
                console.error("jslister.ts: unknown API response for paged output: ".concat(r === null || r === void 0 ? void 0 : r.type));
                // has to be a stream...
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/jsapi_types.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/types.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const jsapi_types_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsapi_types.js [app-client] (ecmascript)");
const jsutil_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsutil.js [app-client] (ecmascript)");
const util_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/util.js [app-client] (ecmascript)");
/**
...
class ConsumerOptsBuilderImpl {
    ...
    sample(n) {
        ...
        this.config.sample_freq = "".concat(n, "%");
        return this;
    }
    limit(n) {
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/jsmconsumer_api.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const jsbaseclient_api_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsbaseclient_api.js [app-client] (ecmascript)");
const jslister_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jslister.js [app-client] (ecmascript)");
const jsutil_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsutil.js [app-client] (ecmascript)");
const semver_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/semver.js [app-client] (ecmascript)");
const jsapi_types_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsapi_types.js [app-client] (ecmascript)");
class ConsumerAPIImpl extends jsbaseclient_api_1.BaseApiClient {
    add(stream_1, cfg_1) {
        return __awaiter(this, arguments, void 0, function*(stream, cfg) {
            let action = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : jsapi_types_1.ConsumerApiAction.Create;
            var _a, _b, _c;
            ...
            if (name && !newAPI) {
                throw new Error("consumer 'name' requires server ".concat(min));
            }
            if (name) {
                try {
                    ...
                    if (idx !== -1) {
                        throw new Error("consumer 'name' ".concat(m.substring(idx)));
                    }
                    throw err;
                }
            }
            ...
            if (Array.isArray(cfg.filter_subjects)) {
                ...
                if (!ok) {
                    throw new Error("consumer 'filter_subjects' requires server ".concat(min));
                }
                newAPI = false;
            }
            if (cfg.metadata) {
                ...
                if (!ok) {
                    throw new Error("consumer 'metadata' requires server ".concat(min));
                }
            }
            if (newAPI) {
            ...
            if (consumerName !== "") {
                ...
                subj = fs !== undefined ? "".concat(this.prefix, ".CONSUMER.CREATE.").concat(stream, ".").concat(consumerName, ".").concat(fs) : "".concat(this.prefix, ".CONSUMER.CREATE.").concat(stream, ".").concat(consumerName);
            } else {
                subj = cfg.durable_name ? "".concat(this.prefix, ".CONSUMER.DURABLE.CREATE.").concat(stream, ".").concat(cfg.durable_name) : "".concat(this.prefix, ".CONSUMER.CREATE.").concat(stream);
            }
    ...
    info(stream, name) {
        return __awaiter(this, void 0, void 0, function*() {
            (0, jsutil_1.validateStreamName)(stream);
            (0, jsutil_1.validateDurableName)(name);
            const r = yield this._request("".concat(this.prefix, ".CONSUMER.INFO.").concat(stream, ".").concat(name));
            return r;
        });
    }
    delete(stream, name) {
        return __awaiter(this, void 0, void 0, function*() {
            (0, jsutil_1.validateStreamName)(stream);
            (0, jsutil_1.validateDurableName)(name);
            const r = yield this._request("".concat(this.prefix, ".CONSUMER.DELETE.").concat(stream, ".").concat(name));
            const cr = r;
            return cr.success;
        });
    }
    list(stream) {
        ...
        const subj = "".concat(this.prefix, ".CONSUMER.LIST.").concat(stream);
        return new jslister_1.ListerImpl(subj, filter, this);
    }
    pause(stream, name, until) {
        const subj = "".concat(this.prefix, ".CONSUMER.PAUSE.").concat(stream, ".").concat(name);
        const opts = {
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/mod.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var internal_mod_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/internal_mod.js [app-client] (ecmascript)");
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/jsmsg.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ const databuffer_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/databuffer.js [app-client] (ecmascript)");
const codec_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/codec.js [app-client] (ecmascript)");
const request_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/request.js [app-client] (ecmascript)");
const mod_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/mod.js [app-client] (ecmascript)");
const util_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/util.js [app-client] (ecmascript)");
...
function toJsMsg(m) {
    let ackTimeout = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 5000;
...
class JsMsgImpl {
                ...
                if (this.msg.reply) {
                    ...
                    try {
                        proto.publish(this.msg.reply, exports.ACK, {
                            reply: "".concat(proto.muxSubscriptions.baseInbox).concat(r.token)
                        });
                    } catch (err) {
                        r.cancel(err);
                    }
    ...
    nak(millis) {
        let payload = NAK;
        if (millis) {
            payload = (0, codec_1.StringCodec)().encode("-NAK ".concat(JSON.stringify({
    ...
    term() {
        ...
        if ((reason === null || reason === void 0 ? void 0 : reason.length) > 0) {
            term = (0, codec_1.StringCodec)().encode("+TERM ".concat(reason));
        }
        this.doAck(term);
    }
    json() {
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/typedsub.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function checkFn(fn, name) {
    let required = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
    if (required === true && !fn) {
        throw core_1.NatsError.errorForCode(core_1.ErrorCode.ApiError, new Error("".concat(name, " is not a function")));
    }
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/base64.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/js-sha256.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
}, S = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable";
function T(t) {
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/sha_digest.parser.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/objectstore.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const kv_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/kv.js [app-client] (ecmascript)");
const base64_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/base64.js [app-client] (ecmascript)");
const codec_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/codec.js [app-client] (ecmascript)");
const nuid_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/nuid.js [app-client] (ecmascript)");
const util_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/util.js [app-client] (ecmascript)");
const databuffer_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/databuffer.js [app-client] (ecmascript)");
const headers_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/headers.js [app-client] (ecmascript)");
const types_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/types.js [app-client] (ecmascript)");
const queued_iterator_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/queued_iterator.js [app-client] (ecmascript)");
const js_sha256_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/js-sha256.js [app-client] (ecmascript)");
const jsapi_types_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsapi_types.js [app-client] (ecmascript)");
const jsclient_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsclient.js [app-client] (ecmascript)");
const sha_digest_parser_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/sha_digest.parser.js [app-client] (ecmascript)");
exports.osPrefix = "OBJ_";
exports.digestType = "SHA-256=";
function objectStoreStreamName(bucket) {
    (0, kv_1.validateBucket)(bucket);
    return "".concat(exports.osPrefix).concat(bucket);
}
...
class ObjectStoreImpl {
            ...
            try {
                ...
                while(true){
                    ...
                    if (done) {
                        ...
                        info.digest = "".concat(exports.digestType).concat(digest);
                        info.deleted = false;
                        // trailing md for the object
                        const h = (0, headers_1.headers)();
                        if (typeof previousRevision === "number") {
                            h.set(jsclient_1.PubHeaders.ExpectedLastSubjectSequenceHdr, "".concat(previousRevision));
                        }
                        ...
                        if (old) {
                            try {
                                yield this.jsm.streams.purge(this.stream, {
                                    filter: "$O.".concat(this.name, ".C.").concat(old.nuid)
                                });
                            } catch (_err) {
    ...
    get(name) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            if (!info.digest.startsWith(exports.digestType)) {
                return Promise.reject(new Error("unknown digest type: ".concat(info.digest)));
            }
            const digest = (0, sha_digest_parser_1.parseSha256)(info.digest.substring(8));
            if (digest === null) {
                return Promise.reject(new Error("unable to parse digest: ".concat(info.digest)));
            }
            const d = (0, util_1.deferred)();
            const r = {
            ...
            oc.orderedConsumer();
            const sha = js_sha256_1.sha256.create();
            const subj = "$O.".concat(this.name, ".C.").concat(info.nuid);
                        ...
                        for(var _d = true, sub_1 = __asyncValues(sub), sub_1_1; sub_1_1 = yield sub_1.next(), _a = sub_1_1.done, !_a; _d = true){
                            ...
                            if (jm.info.pending === 0) {
                                if (!(0, sha_digest_parser_1.checkSha256)(digest, sha.digest())) {
                                    controller.error(new Error("received a corrupt object, digests do not match received: ".concat(info.digest, " calculated ").concat(digest)));
                                } else {
                                    controller.close();
                                }
                                sub.unsubscribe();
    ...
    _chunkSubject(id) {
        return "$O.".concat(this.name, ".C.").concat(id);
    }
    _metaSubject(n) {
        return "$O.".concat(this.name, ".M.").concat(base64_1.Base64UrlPaddedCodec.encode(n));
    }
    _metaSubjectAll() {
        return "$O.".concat(this.name, ".M.>");
    }
    init() {
        return __awaiter(this, arguments, void 0, function*() {
            let opts = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            ...
            sc.subjects = [
                "$O.".concat(this.name, ".C.>"),
                "$O.".concat(this.name, ".M.>")
            ];
            if (opts.placement) {
    ...
    static create(js_1, name_1) {
        return __awaiter(this, arguments, void 0, function*(js, name) {
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/idleheartbeat_monitor.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class IdleHeartbeatMonitor {
     ...
     * @param maxOut
     */ _change(interval) {
        let cancelAfter = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, maxOut = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 2;
        this.interval = interval;
        this.maxOut = maxOut;
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/jsclient.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const types_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/types.js [app-client] (ecmascript)");
const jsbaseclient_api_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsbaseclient_api.js [app-client] (ecmascript)");
const jsutil_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsutil.js [app-client] (ecmascript)");
const jsmconsumer_api_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsmconsumer_api.js [app-client] (ecmascript)");
const jsmsg_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsmsg.js [app-client] (ecmascript)");
const typedsub_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/typedsub.js [app-client] (ecmascript)");
const queued_iterator_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/queued_iterator.js [app-client] (ecmascript)");
const util_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/util.js [app-client] (ecmascript)");
const headers_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/headers.js [app-client] (ecmascript)");
const kv_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/kv.js [app-client] (ecmascript)");
const semver_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/semver.js [app-client] (ecmascript)");
const objectstore_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/objectstore.js [app-client] (ecmascript)");
const idleheartbeat_monitor_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/idleheartbeat_monitor.js [app-client] (ecmascript)");
const jsmstream_api_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsmstream_api.js [app-client] (ecmascript)");
const types_2 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/types.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
const jsapi_types_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsapi_types.js [app-client] (ecmascript)");
const nuid_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/nuid.js [app-client] (ecmascript)");
var PubHeaders;
...
class ViewsImpl {
    kv(name) {
        ...
        if (!ok) {
            return Promise.reject(new Error("kv is only supported on servers ".concat(min, " or better")));
        }
        if (opts.bindOnly) {
    ...
    os(name) {
        ...
        if (!ok) {
            return Promise.reject(new Error("objectstore is only supported on servers ".concat(min, " or better")));
        }
...
class JetStreamClientImpl extends jsbaseclient_api_1.BaseApiClient {
    ...
    publish(subj_1) {
        return __awaiter(this, arguments, void 0, function*(subj) {
            let data = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : types_1.Empty, opts = arguments.length > 2 ? arguments[2] : void 0;
            opts = opts || {};
            ...
            if (opts) {
                ...
                if (typeof opts.expect.lastSequence === "number") {
                    mh.set(PubHeaders.ExpectedLastSeqHdr, "".concat(opts.expect.lastSequence));
                }
                if (typeof opts.expect.lastSubjectSequence === "number") {
                    mh.set(PubHeaders.ExpectedLastSubjectSequenceHdr, "".concat(opts.expect.lastSubjectSequence));
                }
            }
    ...
    pull(stream_1, durable_1) {
        return __awaiter(this, arguments, void 0, function*(stream, durable) {
            let expires = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
            (0, jsutil_1.validateStreamName)(stream);
            ...
            const msg = yield this.nc.request("".concat(this.prefix, ".CONSUMER.MSG.NEXT.").concat(stream, ".").concat(durable), this.jc.encode(pullOpts), {
                noMux: true,
                timeout
            });
     ...
     */ fetch(stream, durable) {
        ...
        if (max_bytes) {
            ...
            if (!fv.ok) {
                throw new Error("max_bytes is only supported on servers ".concat(fv.min, " or better"));
            }
        ...
        let received = 0;
        qi.protocolFilterFn = function(jm) {
            let _ingest = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
            const jsmi = jm;
                    ...
                    if (hb) {
                        monitor = new idleheartbeat_monitor_1.IdleHeartbeatMonitor(hb, (v)=>{
                            ...
                            qi.push(()=>{
                                ...
                                qi.err = new types_1.NatsError("".concat(jsutil_1.Js409Errors.IdleHeartbeatMissed, ": ").concat(v), core_1.ErrorCode.JetStreamIdleHeartBeat);
                            });
                            return true;
                        });
                    }
        ...
        this.nc.publish("".concat(this.prefix, ".CONSUMER.MSG.NEXT.").concat(stream, ".").concat(durable), this.jc.encode(args), {
            reply: inbox
        });
        return qi;
    }
    pullSubscribe(subject_1) {
        return __awaiter(this, arguments, void 0, function*(subject) {
            let opts = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : (0, types_2.consumerOpts)();
                    ...
                    if (info) {
                        ...
                        if (qn !== rqn) {
                            if (rqn === "") {
                                ...
                                throw new Error("durable requires queue group '".concat(rqn, "'"));
                            }
                        }
                        jsi.last = info;
    ...
    _buildTypedSubscriptionOpts(jsi) {
        ...
        so.protocolFilterFn = function(jm) {
            let ingest = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
            const jsmi = jm;
    ...
    _maybeCreateConsumer(jsi) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            if (jsi.isBind) {
                throw new Error("unable to bind - durable consumer ".concat(jsi.config.durable_name, " doesn't exist in ").concat(jsi.stream));
            }
...
class JetStreamSubscriptionImpl extends typedsub_1.TypedSubscription {
    ...
    _resetOrderedConsumer(sseq) {
        ...
        const subj = "".concat(info.api.prefix, ".CONSUMER.CREATE.").concat(info.stream);
        this.js._request(subj, req, {
            ...
            const nerr = new types_1.NatsError("unable to recreate ordered consumer ".concat(info.stream, " at seq ").concat(sseq), core_1.ErrorCode.RequestError, err);
    ...
    _setupHbMonitoring(millis) {
        let cancelAfter = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
        const opts = {
            cancelAfter: 0,
            maxOut: 2
        };
        ...
        const handler = (v)=>{
            var _a, _b, _c, _d;
            const msg = (0, jsutil_1.newJsErrorMsg)(409, "".concat(jsutil_1.Js409Errors.IdleHeartbeatMissed, ": ").concat(v), this.sub.subject);
    ...
    destroy() {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            const subj = "".concat(jinfo.api.prefix, ".CONSUMER.DELETE.").concat(jinfo.stream, ".").concat(name);
    ...
    consumerInfo() {
        return __awaiter(this, void 0, void 0, function*() {
            const jinfo = this.sub.info;
            const name = jinfo.config.durable_name || jinfo.name;
            const subj = "".concat(jinfo.api.prefix, ".CONSUMER.INFO.").concat(jinfo.stream, ".").concat(name);
...
class JetStreamPullSubscriptionImpl extends JetStreamSubscriptionImpl {
    pull() {
        ...
        if (this.info) {
            ...
            const subj = "".concat(api.prefix, ".CONSUMER.MSG.NEXT.").concat(stream, ".").concat(consumer);
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/kv.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function validateKey(k) {
    if (k.startsWith(".") || k.endsWith(".") || !validKeyRe.test(k)) {
        throw new Error("invalid key: ".concat(k));
    }
}
...
function validateBucket(name) {
    if (!validBucketRe.test(name)) {
        throw new Error("invalid bucket name: ".concat(name));
    }
}
class Bucket {
    static create(js_1, name_1) {
        ...
        return __awaiter(this, arguments, void 0, function*() {
            ...
            if (opts.mirror) {
                ...
                if (!mirror.name.startsWith(types_1.kvPrefix)) {
                    mirror.name = "".concat(types_1.kvPrefix).concat(mirror.name);
                }
                sc.mirror = mirror;
                ...
                const sources = opts.sources.map((s)=>{
                    ...
                    if (!c.name.startsWith(types_1.kvPrefix)) {
                        c.name = "".concat(types_1.kvPrefix).concat(c.name);
                    }
                    if (!s.external && srcBucketName !== this.bucket) {
                        c.subject_transforms = [
                            {
                                src: "$KV.".concat(srcBucketName, ".>"),
                                dest: "$KV.".concat(this.bucket, ".>")
                            }
                        ];
                    }
                    return c;
            ...
            if (!direct && opts.allow_direct === true) {
                const v = have ? "".concat(have.major, ".").concat(have.minor, ".").concat(have.micro) : "unknown";
                return Promise.reject(new Error("allow_direct is not available on server version ".concat(v, " - requires ").concat(min)));
            }
    ...
    initializePrefixes(info) {
        this._prefixLen = 0;
        this.prefix = "$KV.".concat(this.bucket);
        ...
        if (mirror) {
            ...
            if (mirror.external && mirror.external.api !== "") {
                ...
                this.prefix = "$KV.".concat(mb);
                this.editPrefix = "".concat(mirror.external.api, ".$KV.").concat(n);
            } else {
    ...
    bucketName() {
        var _a;
        return (_a = this.stream) !== null && _a !== void 0 ? _a : "".concat(types_1.kvPrefix).concat(this.bucket);
    }
    subjectForBucket() {
        return "".concat(this.prefix, ".").concat(this.bucket, ".>");
    }
    subjectForKey(k) {
        let edit = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
        const builder = [];
        if (edit) {
            if (this.useJsPrefix) {
    ...
    fullKeyName(k) {
        ...
        return "".concat(kvSubjectPrefix, ".").concat(this.bucket, ".").concat(k);
    }
    get prefixLen() {
    ...
    put(k_1, data_1) {
        return __awaiter(this, arguments, void 0, function*(k, data) {
            let opts = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            var _a, _b;
            ...
            if (opts.previousSeq !== undefined) {
                const h = (0, headers_1.headers)();
                o.headers = h;
                h.set(jsclient_1.PubHeaders.ExpectedLastSubjectSequenceHdr, "".concat(opts.previousSeq));
            }
            try {
                ...
                if (ne.isJetStreamError()) {
                    ...
                    ne.code = "".concat((_b = ne.api_error) === null || _b === void 0 ? void 0 : _b.code);
    ...
    purgeDeletes() {
        return __awaiter(this, arguments, void 0, function*() {
            let olderMillis = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 30 * 60 * 1000;
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/consumer.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class PullConsumerMessagesImpl extends queued_iterator_1.QueuedIteratorImpl {
            ...
            callback: (err, msg)=>{
                ...
                if (isProtocol) {
                    ...
                    if (msgsLeft > 0 || bytesLeft > 0) {
                        ...
                        if (code === 400) {
                            this.stop(new core_1.NatsError(description, "".concat(code)));
                            return;
                        } else if (code === 409 && description === "consumer deleted") {
                            this.notify(ConsumerEvents.ConsumerDeleted, "".concat(code, " ").concat(description));
                            if (!this.refilling || this.abortOnMissingResource) {
                                const error = new core_1.NatsError(description, "".concat(code));
                                this.stop(error);
                                return;
                            }
                        } else if (code === 503) {
                            ...
                            this.notify(ConsumerEvents.NoResponders, "".concat(code, " No Responders"));
                            // in cases that we are in consume, the idle heartbeat will kick in
                            // which will do a reset, and possibly refine the error
                            if (!this.refilling || this.abortOnMissingResource) {
                                const error = new core_1.NatsError("no responders", "".concat(code));
                                this.stop(error);
                                return;
                            }
                        } else {
                            this.notify(ConsumerDebugEvents.DebugEvent, "".concat(code, " ").concat(description));
                        }
                    }
                } else {
    ...
    pull(opts) {
        ...
        this._push(()=>{
            nc.publish("".concat(this.consumer.api.prefix, ".CONSUMER.MSG.NEXT.").concat(this.consumer.stream, ".").concat(this.consumer.name), this.consumer.api.jc.encode(opts), {
                reply: this.inbox
            });
    ...
    parseOptions(opts) {
        let refilling = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
        const args = opts || {};
...
class PullConsumerImpl {
    ...
    info() {
        let cached = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
        if (cached) {
...
class OrderedPullConsumerImpl {
    getConsumerOpts(seq) {
        ...
        // matching the serial
        this.serial++;
        const name = "".concat(this.namePrefix, "_").concat(this.serial);
        seq = seq === 0 ? 1 : seq;
        const config = {
            name,
    ...
    resetConsumer() {
        return __awaiter(this, arguments, void 0, function*() {
            let seq = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0;
            var _a, _b, _c, _d, _e;
            const id = nuid_1.nuid.next();
    ...
    reset() {
        return __awaiter(this, arguments, void 0, function*() {
            let opts = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {
                max_messages: 100,
                expires: 30000
            }, info = arguments.length > 1 ? arguments[1] : void 0;
            var _a, _b;
            info = info || {};
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/jsmstream_api.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const semver_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/semver.js [app-client] (ecmascript)");
const types_2 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/types.js [app-client] (ecmascript)");
const consumer_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/consumer.js [app-client] (ecmascript)");
const jsmconsumer_api_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsmconsumer_api.js [app-client] (ecmascript)");
...
class ConsumersImpl {
    checkVersion() {
        ...
        if (!fv.ok) {
            return Promise.reject(new Error("consumers framework is only supported on servers ".concat(fv.min, " or better")));
        }
        return Promise.resolve();
    }
    ...
    get(stream_1) {
        return __awaiter(this, arguments, void 0, function*(stream) {
            let name = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
class StreamImpl {
    ...
    info() {
        let cached = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false, opts = arguments.length > 1 ? arguments[1] : void 0;
        if (cached) {
            return Promise.resolve(this._info);
        }
...
class StreamAPIImpl extends jsbaseclient_api_1.BaseApiClient {
    checkStreamConfigVersions(cfg) {
        ...
        function validateStreamSource(context, src) {
            ...
            if (count > 0) {
                ...
                if (!ok) {
                    throw new Error("".concat(context, " 'subject_transforms' requires server ").concat(min));
                }
            }
        }
        if (cfg.sources) {
    ...
    add() {
        return __awaiter(this, arguments, void 0, function*() {
            ...
            const r = yield this._request("".concat(this.prefix, ".STREAM.CREATE.").concat(cfg.name), cfg);
            const si = r;
            this._fixInfo(si);
            return si;
        });
    ...
    delete(stream) {
        return __awaiter(this, void 0, void 0, function*() {
            (0, jsutil_1.validateStreamName)(stream);
            const r = yield this._request("".concat(this.prefix, ".STREAM.DELETE.").concat(stream));
            const cr = r;
            return cr.success;
        });
    }
    update(name_1) {
        return __awaiter(this, arguments, void 0, function*(name) {
            ...
            const r = yield this._request("".concat(this.prefix, ".STREAM.UPDATE.").concat(name), update);
            const si = r;
            this._fixInfo(si);
            return si;
        });
    ...
    info(name, data) {
        return __awaiter(this, void 0, void 0, function*() {
            (0, jsutil_1.validateStreamName)(name);
            const subj = "".concat(this.prefix, ".STREAM.INFO.").concat(name);
    ...
    list() {
        ...
        const subj = "".concat(this.prefix, ".STREAM.LIST");
    ...
    purge(name, opts) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            (0, jsutil_1.validateStreamName)(name);
            const v = yield this._request("".concat(this.prefix, ".STREAM.PURGE.").concat(name), opts);
            return v;
        });
    }
    deleteMessage(stream_1, seq_1) {
        return __awaiter(this, arguments, void 0, function*(stream, seq) {
            let erase = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
            (0, jsutil_1.validateStreamName)(stream);
            const dr = {
                seq
            };
            ...
            const r = yield this._request("".concat(this.prefix, ".STREAM.MSG.DELETE.").concat(stream), dr);
            const cr = r;
            return cr.success;
        });
    }
    getMessage(stream, query) {
        return __awaiter(this, void 0, void 0, function*() {
            (0, jsutil_1.validateStreamName)(stream);
            const r = yield this._request("".concat(this.prefix, ".STREAM.MSG.GET.").concat(stream), query);
            const sm = r;
    ...
    names() {
        ...
        const subj = "".concat(this.prefix, ".STREAM.NAMES");
        return new jslister_1.ListerImpl(subj, listerFilter, this, payload);
    }
    get(name) {
        return __awaiter(this, void 0, void 0, function*() {
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/jsm.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class DirectStreamAPIImpl extends jsbaseclient_api_1.BaseApiClient {
    getMessage(stream, query) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            const subj = last_by_subj ? "".concat(pre, ".DIRECT.GET.").concat(stream, ".").concat(last_by_subj) : "".concat(pre, ".DIRECT.GET.").concat(stream);
    ...
    getBatch(stream, opts) {
        return __awaiter(this, void 0, void 0, function*() {
            (0, jsutil_1.validateStreamName)(stream);
            const pre = this.opts.apiPrefix || "$JS.API";
            const subj = "".concat(pre, ".DIRECT.GET.").concat(stream);
            ...
            (()=>__awaiter(this, void 0, void 0, function*() {
                    ...
                    iter.push(()=>{
                        ...
                        if (badRequest) {
                            throw new Error("bad request: ".concat(badRequest));
                        }
                        iter.stop();
                    });
                }))();
...
class JetStreamManagerImpl extends jsbaseclient_api_1.BaseApiClient {
    getAccountInfo() {
        return __awaiter(this, void 0, void 0, function*() {
            const r = yield this._request("".concat(this.prefix, ".INFO"));
            return r;
        });
    }
    jetstream() {
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/service.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class ServiceMsgImpl {
    ...
    respondError(code, description, data, opts) {
        ...
        (_a = opts.headers) === null || _a === void 0 ? void 0 : _a.set(core_1.ServiceErrorCodeHeader, "".concat(code));
...
class ServiceGroupImpl {
    calcSubject(root) {
        ...
        return root !== "" ? "".concat(root, ".").concat(name) : name;
    }
    addEndpoint() {
        let name = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "", opts = arguments.length > 1 ? arguments[1] : void 0;
        opts = opts || {
            subject: name
        };
    ...
    addGroup() {
        let name = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "", queue = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
...
function validSubjectName(context, subj) {
    if (subj === "") {
        throw new Error("".concat(context, " cannot be empty"));
    }
    if (subj.indexOf(" ") !== -1) {
        throw new Error("".concat(context, " cannot contain spaces: '").concat(subj, "'"));
    }
    const tokens = subj.split(".");
    tokens.forEach((v, idx)=>{
        if (v === ">" && idx !== tokens.length - 1) {
            throw new Error("".concat(context, " cannot have internal '>': '").concat(subj, "'"));
        }
    });
}
function validInternalToken(context, subj) {
    ...
    tokens.forEach((v)=>{
        if (v === ">") {
            throw new Error("".concat(context, " name cannot contain internal '>': '").concat(subj, "'"));
        }
    });
}
class ServiceImpl {
     ...
     */ static controlSubject(verb) {
        let name = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "", id = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "", prefix = arguments.length > 3 ? arguments[3] : void 0;
        ...
        if (name === "" && id === "") {
            return "".concat(pre, ".").concat(verb);
        }
        (0, jsutil_1.validateName)("control subject name", name);
        if (id !== "") {
            (0, jsutil_1.validateName)("control subject id", id);
            return "".concat(pre, ".").concat(verb, ".").concat(name, ".").concat(id);
        }
        return "".concat(pre, ".").concat(verb, ".").concat(name);
    }
    get subjects() {
    ...
    errorToHeader(err) {
        ...
        if (err instanceof core_1.ServiceError) {
            ...
            h.set(core_1.ServiceErrorCodeHeader, "".concat(se.code));
        } else {
    ...
    setupHandler(h) {
        let internal = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
        ...
        sv.sub.closed.then(()=>{
            if (!this._stopped) {
                this.close(new Error("required subscription ".concat(h.subject, " stopped"))).catch();
            }
        }).catch((err)=>{
            if (!this._stopped) {
                const ne = new Error("required subscription ".concat(h.subject, " errored: ").concat(err.message));
                ne.stack = err.stack;
                this.close(ne).catch();
            }
        });
    ...
    addInternalHandler(verb, handler) {
        const v = "".concat(verb).toUpperCase();
        this._doAddInternalHandler("".concat(v, "-all"), verb, handler);
        this._doAddInternalHandler("".concat(v, "-kind"), verb, handler, this.name);
        this._doAddInternalHandler("".concat(v), verb, handler, this.name, this.id);
    }
    _doAddInternalHandler(name, verb, handler) {
        let kind = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "", id = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : "";
        const endpoint = {};
        endpoint.name = name;
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/serviceclient.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const queued_iterator_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/queued_iterator.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
const service_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/service.js [app-client] (ecmascript)");
const core_2 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
class ServiceClientImpl {
    ping() {
        let name = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "", id = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
    ...
    q(v_1) {
        return __awaiter(this, arguments, void 0, function*(v) {
            let name = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "", id = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "";
            const iter = new queued_iterator_1.QueuedIteratorImpl();
            const jc = (0, codec_1.JSONCodec)();
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/nats.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const util_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/util.js [app-client] (ecmascript)");
const protocol_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/protocol.js [app-client] (ecmascript)");
const encoders_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/encoders.js [app-client] (ecmascript)");
const types_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/types.js [app-client] (ecmascript)");
const semver_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/semver.js [app-client] (ecmascript)");
const options_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/options.js [app-client] (ecmascript)");
...
const request_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/request.js [app-client] (ecmascript)");
const msg_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/msg.js [app-client] (ecmascript)");
const jsm_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsm.js [app-client] (ecmascript)");
const jsclient_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsclient.js [app-client] (ecmascript)");
const service_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/service.js [app-client] (ecmascript)");
const serviceclient_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/serviceclient.js [app-client] (ecmascript)");
const core_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/core.js [app-client] (ecmascript)");
class NatsConnectionImpl {
    ...
    requestMany(subject) {
        let data = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : encoders_1.Empty, opts = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {
            maxWait: 1000,
            maxMessages: -1
        };
        ...
        if (opts.noMux) {
            ...
            try {
                this.publish(subject, data, {
                    reply: "".concat(this.protocol.muxSubscriptions.baseInbox).concat(r.token),
...
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/bench.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class Metric {
    toString() {
        ...
        let minmax = "";
        if (this.max) {
            minmax = "".concat(this.min, "/").concat(this.max);
        }
        return "".concat(this.name).concat(label ? " [asyncRequests]" : "", " ").concat(humanizeNumber(mps), " msgs/sec - [").concat(sec.toFixed(2), " secs] ~ ").concat(throughput(this.bytes, sec), " ").concat(minmax);
    }
    toCsv() {
        return '"'.concat(this.name, '",').concat(new Date(this.date).toISOString(), ",").concat(this.lang, ",").concat(this.version, ",").concat(this.msgs, ",").concat(this.payload, ",").concat(this.bytes, ",").concat(this.duration, ",").concat(this.asyncRequests ? this.asyncRequests : false, "\n");
    }
    static header() {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function*() {
            this.nc.closed().then((err)=>{
                if (err) {
                    throw new core_1.NatsError("bench closed with an error: ".concat(err.message), core_1.ErrorCode.Unknown, err);
                }
            });
            if (this.callbacks) {
...
function throughput(bytes, seconds) {
    return "".concat(humanizeBytes(bytes / seconds), "/sec");
}
function msgThroughput(msgs, seconds) {
    return "".concat(Math.floor(msgs / seconds), " msgs/sec");
}
function humanizeBytes(bytes) {
    let si = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
    ...
    const post = si ? "iB" : "B";
    if (bytes < base) {
        return "".concat(bytes.toFixed(2), " ").concat(post);
    }
    const exp = parseInt(Math.log(bytes) / Math.log(base) + "");
    const index = parseInt(exp - 1 + "");
    return "".concat((bytes / Math.pow(base, exp)).toFixed(2), " ").concat(pre[index]).concat(post);
}
function humanizeNumber(n) {
    return n.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
} //# sourceMappingURL=bench.js.map
}),
"[project]/dawg-ai/node_modules/nats/lib/nats-base-client/internal_mod.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var nats_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/nats.js [app-client] (ecmascript)");
...
var nuid_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/nuid.js [app-client] (ecmascript)");
Object.defineProperty(exports, "Nuid", {
    enumerable: true,
    get: function() {
        return nuid_1.Nuid;
...
var msg_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/msg.js [app-client] (ecmascript)");
...
var transport_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/transport.js [app-client] (ecmascript)");
...
var protocol_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/protocol.js [app-client] (ecmascript)");
...
var util_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/util.js [app-client] (ecmascript)");
Object.defineProperty(exports, "backoff", {
    enumerable: true,
    get: function() {
...
var headers_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/headers.js [app-client] (ecmascript)");
Object.defineProperty(exports, "canonicalMIMEHeaderKey", {
    enumerable: true,
    get: function() {
...
var heartbeats_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/heartbeats.js [app-client] (ecmascript)");
...
var muxsubscription_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/muxsubscription.js [app-client] (ecmascript)");
...
var databuffer_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/databuffer.js [app-client] (ecmascript)");
...
var options_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/options.js [app-client] (ecmascript)");
Object.defineProperty(exports, "buildAuthenticator", {
    enumerable: true,
    get: function() {
...
var request_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/request.js [app-client] (ecmascript)");
...
var authenticator_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/authenticator.js [app-client] (ecmascript)");
Object.defineProperty(exports, "credsAuthenticator", {
    enumerable: true,
    get: function() {
...
var codec_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/codec.js [app-client] (ecmascript)");
Object.defineProperty(exports, "JSONCodec", {
    enumerable: true,
    get: function() {
...
__exportStar(__turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/nkeys.js [app-client] (ecmascript)"), exports);
var queued_iterator_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/queued_iterator.js [app-client] (ecmascript)");
...
var parser_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/parser.js [app-client] (ecmascript)");
...
var denobuffer_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/denobuffer.js [app-client] (ecmascript)");
...
var bench_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/bench.js [app-client] (ecmascript)");
Object.defineProperty(exports, "Bench", {
    enumerable: true,
    get: function() {
...
var ipparser_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/ipparser.js [app-client] (ecmascript)");
...
var typedsub_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/typedsub.js [app-client] (ecmascript)");
...
var kv_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/kv.js [app-client] (ecmascript)");
...
var semver_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/semver.js [app-client] (ecmascript)");
...
var types_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/types.js [app-client] (ecmascript)");
Object.defineProperty(exports, "Empty", {
    enumerable: true,
    get: function() {
...
var transport_2 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/transport.js [app-client] (ecmascript)");
...
var protocol_2 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/protocol.js [app-client] (ecmascript)");
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/internal_mod.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var jsutil_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsutil.js [app-client] (ecmascript)");
...
var types_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/types.js [app-client] (ecmascript)");
...
var jsapi_types_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/jsapi_types.js [app-client] (ecmascript)");
...
var consumer_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/consumer.js [app-client] (ecmascript)");
...
"[project]/dawg-ai/node_modules/nats/lib/src/nats-base-client.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ __exportStar(__turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/internal_mod.js [app-client] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/internal_mod.js [app-client] (ecmascript)"), exports); //# sourceMappingURL=nats-base-client.js.map
}),
"[project]/dawg-ai/node_modules/nats/lib/src/node_transport.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const nats_base_client_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/src/nats-base-client.js [app-client] (ecmascript)");
const net_1 = (()=>{
...
const { resolve } = __turbopack_context__.r("[project]/dawg-ai/node_modules/next/dist/compiled/path-browserify/index.js [app-client] (ecmascript)");
const { readFile, existsSync } = (()=>{
...
class NodeTransport {
    ...
    loadFile(fn) {
        ...
        try {
            fn = resolve(fn);
            if (!existsSync(fn)) {
                d.reject(new Error("".concat(fn, " doesn't exist")));
            }
    ...
    iterate() {
        return __asyncGenerator(this, arguments, function* iterate_1() {
            ...
            while(true){
                ...
                for(let i = 0; i < yields.length; i++){
                    if (debug) {
                        console.info("> ".concat((0, nats_base_client_1.render)(yields[i])));
                    }
                    yield yield __await(yields[i]);
                }
                // yielding could have paused and microtask
    ...
    _send(frame) {
        ...
        if (this.options.debug) {
            console.info("< ".concat((0, nats_base_client_1.render)(frame)));
        }
        const d = (0, nats_base_client_1.deferred)();
        try {
            this.socket.write(frame, (err)=>{
                if (err) {
                    if (this.options.debug) {
                        console.error("!!! ".concat((0, nats_base_client_1.render)(frame), ": ").concat(err));
                    }
                    return d.reject(err);
                }
                return d.resolve();
    ...
    _closed(err_1) {
        return __awaiter(this, arguments, void 0, function*(err) {
            let internal = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
...
"[project]/dawg-ai/node_modules/nats/lib/src/connect.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const node_transport_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/src/node_transport.js [app-client] (ecmascript)");
const nats_base_client_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/src/nats-base-client.js [app-client] (ecmascript)");
function connect() {
    let opts = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
"[project]/dawg-ai/node_modules/nats/lib/jetstream/mod.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var internal_mod_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/internal_mod.js [app-client] (ecmascript)");
Object.defineProperty(exports, "checkJsError", {
    enumerable: true,
    get: function() {
...
var internal_mod_2 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/internal_mod.js [app-client] (ecmascript)");
Object.defineProperty(exports, "AckPolicy", {
    enumerable: true,
    get: function() {
...
"[project]/dawg-ai/node_modules/nats/lib/src/mod.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ if (typeof TextEncoder === "undefined") {
    const { TextEncoder: TextEncoder1, TextDecoder } = __turbopack_context__.r("[project]/dawg-ai/node_modules/next/dist/compiled/util/util.js [app-client] (ecmascript)");
...
if (typeof globalThis.crypto === "undefined") {
    const c = __turbopack_context__.r("[project]/dawg-ai/node_modules/next/dist/compiled/crypto-browserify/index.js [app-client] (ecmascript)");
...
if (typeof globalThis.ReadableStream === "undefined") {
    ...
    const chunks = __TURBOPACK__imported__module__$5b$project$5d2f$dawg$2d$ai$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].versions.node.split(".");
...
var connect_1 = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/src/connect.js [app-client] (ecmascript)");
Object.defineProperty(exports, "connect", {
    enumerable: true,
    get: function() {
...
__exportStar(__turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/nats-base-client/mod.js [app-client] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/jetstream/mod.js [app-client] (ecmascript)"), exports); //# sourceMappingURL=mod.js.map
}),
"[project]/dawg-ai/node_modules/nats/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ module.exports = __turbopack_context__.r("[project]/dawg-ai/node_modules/nats/lib/src/mod.js [app-client] (ecmascript)");
}),
]);

//# sourceMappingURL=f2656_nats_36111ec9._.js.map